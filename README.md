# Eintracht Spontent Düsseldorf - Saison 2025/26

Statische Webseite mit Spielkarten zur Saison 2025/26 von Eintracht Spontent Düsseldorf in der Sparda 2. Liga Pro.
...
- Kreuztabelle
- Saisonbilanz
- Düsseldorfer MVP-Auswertung
- YouTube-Suchlinks als Platzhalter fuer spaeter nachzutragende Direktvideos
...
```text
https://knud-zabrocki.de/eintracht-spontent-duesseldorf-2025-26/
```
...
```html
<iframe
  src="https://knud-zabrocki.de/eintracht-spontent-duesseldorf-2025-26/"
...
```text
https://github.com/Zappi77/eintracht-spontent-duesseldorf-2025-26
```
...
```text
https://zappi77.github.io/eintracht-spontent-duesseldorf-2025-26/
```
...
- 50 Vereinsartikel aus den VBL-Spieldetails übernommen und mit Vereinskuerzel gekennzeichnet
...
- alle 28 offiziellen Spielberichte und 28 Statistikadressen geprüft; nicht verfügbare Statistiken entsprechend gekennzeichnet
- Impressum, Datenschutz und Copyright im Footer ergänzt
- geerbte teamfremde Bezeichner in JavaScript und CSS bereinigt
- Saisonbilanz und Spielkarten für schmale Bildschirmbreiten angepasst

### 25.06.2026

- Projekt aus der Leverkusen-Vorlage für Eintracht Spontent Düsseldorf angelegt
- 28 Düsseldorfer Ligaspiele aus der offiziellen VBL-Teamseite übernommen
...
- Tabellenplatz nach jedem Düsseldorfer Spiel aus allen 210 Ligaergebnissen berechnet
...
- YouTube-Suchlinks nach DYN-/Düsseldorf-Videos als Platzhalter ergänzt
- direkte YouTube-Links fuer alle 28 Saisonspiele ergänzt
- YouTube-Aufrufzahlen fuer alle 28 Videos mit Stand 25.06.2026 erfasst
...
- externen Linkcheck fuer 108 eindeutige VBL-/SAMS-/Logo-/Teamlinks durchgeführt
